...
let compteurC=document.querySelectorAll(".square-closed");
compteurC.addEventListener("click", comptage);
*/
//2 option
// Sélectionner le div avec l'ID "myDiv"
//const myCard = document.querySelectorAll('square-closed');

// Ajouter un événement de clic au div pour instant ne fonctionne pas
/*
myCard.addEventListener('click', function() {
    const newCompt=document.createElement("div");
    newCompt.innerHTML=`<h3> Votre score : ${clicks} </h3>`;
    
});
document.querySelector("nombreClicks").appendChild(newCompt);     
*/
